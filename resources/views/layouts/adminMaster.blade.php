...
<head>
  ...
  <link rel="stylesheet" href="{{asset('admin/bundles/codemirror/lib/codemirror.css')}}">
  <link rel="stylesheet" href="{{asset('admin/bundles/codemirror/theme/duotone-dark.css')}}">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
              ...
              <div class="dropdown-footer text-center">
                <a href="{{ route('logout')}}">logout <i class="fas fa-chevron-right"></i></a>
              </div>
            </div>
          </li>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="{{ route('admin.category.index')}}" class="nav-link"><i data-feather="monitor"></i><span>Kurslar</span></a>
            </li>
            <li class="dropdown">
              <a href="{{route('admin.question.index')}}" class="nav-link"><i data-feather="monitor"></i><span>Savolar</span></a>
            </li>
            <li class="dropdown">
              <a href="{{route('admin.course.index')}}" class="nav-link"><i data-feather="monitor"></i><span>Kurs Dasturi</span></a>
            </li>
            <li class="dropdown">
              <a href="{{route('admin.modul.index')}}" class="nav-link"><i data-feather="monitor"></i><span>Kurs Modullari</span></a>
            </li>
            <li class="dropdown">
              <a href="{{route('admin.step.index')}}" class="nav-link"><i data-feather="monitor"></i><span>Step</span></a>
            </li>
            <li class="dropdown">
              <a href="{{route('admin.contact.index')}}" class="nav-link"><i data-feather="monitor"></i><span>Bog'lanish</span></a>
            </li>
          </ul>
        </aside>
      </div>
